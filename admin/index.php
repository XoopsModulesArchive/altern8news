...
// $Id: index.php,v 1.2 2006/03/18 16:41:32 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
function topicsmanager()
{
    ...
    $topics_array = XoopsLists::getImgListAsArray(XOOPS_ROOT_PATH . '/modules/altern8news/images/topics/');
    ...
    $result = $xoopsDB->query('select count(*) from ' . $xoopsDB->prefix('temen') . '');
...
function modTopic()
{
    ...
    echo '<b>' . _AM_TOPICNAME . '</b>&nbsp;' . _AM_MAX40CHAR . "<br><input type='text' name='topic_title' size='20' maxlength='40' value='" . $xt->topic_title() . "'><br>";
    ...
    case 'preview':
        ...
        if ($topicdisplay) {
            ...
            if (empty($topicid)) {
                ...
                $xt = new XoopsTopic($xoopsDB->prefix('temen'), $topicid);

                if ('' != $xt->topic_imgurl() && file_exists(XOOPS_ROOT_PATH . '/modules/altern8news/images/topics/' . $xt->topic_imgurl())) {
                    $timage = "<img src='" . XOOPS_URL . '/modules/altern8news/images/topics/' . $xt->topic_imgurl() . "' align='$align' border='0' hspace='10' vspace=10'>";
                }
            }
        }
