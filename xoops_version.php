...
// $Id: xoops_version.php,v 1.2 2006/03/18 16:41:35 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
//  ------------------------------------------------------------------------ //
$modversion['name'] = _MI_ALT_NEWS_NAME;
$modversion['version'] = 1.1;
$modversion['description'] = _MI_ALT_NEWS_DESC;
$modversion['credits'] = 'The XOOPS Project';
$modversion['help'] = 'news.html';
$modversion['license'] = 'GPL see LICENSE';
$modversion['official'] = 1;
$modversion['image'] = 'images/altern8logo.gif';
$modversion['dirname'] = 'altern8news';
...
$modversion['tables'][0] = 'atikel';
$modversion['tables'][1] = 'temen';
...
$modversion['blocks'][1]['name'] = _MI_ALT_NEWS_BNAME1;
...
$modversion['blocks'][2]['name'] = _MI_ALT_NEWS_BNAME3;
...
$modversion['blocks'][3]['name'] = _MI_ALT_NEWS_BNAME4;
...
$modversion['blocks'][4]['name'] = _MI_ALT_NEWS_BNAME5;
...
$modversion['sub'][1]['name'] = _MI_ALT_NEWS_SMNAME1;
$modversion['sub'][1]['url'] = 'submit.php';
$modversion['sub'][2]['name'] = _MI_ALT_NEWS_SMNAME2;
$modversion['sub'][2]['url'] = 'archive.php';

// Search
$modversion['hasSearch'] = 1;
$modversion['search']['file'] = 'include/search.inc.php';
$modversion['search']['func'] = 'altern8news_search';
...
$modversion['config'][1]['title'] = '_MI_ALT_STORYHOME';

// description of this config option displayed under title
$modversion['config'][1]['description'] = '_MI_ALT_STORYHOMEDSC';
...
$modversion['config'][2]['title'] = '_MI_ALT_NOTIFYSUBMIT';
$modversion['config'][2]['description'] = '_MI_ALT_NOTIFYSUBMITDSC';
...
$modversion['config'][3]['title'] = '_MI_ALT_DISPLAYNAV';
$modversion['config'][3]['description'] = '_MI_ALT_DISPLAYNAVDSC';
$modversion['config'][3]['formtype'] = 'yesno';
$modversion['config'][3]['valuetype'] = 'int';
$modversion['config'][3]['default'] = 1;

$modversion['config'][4]['name'] = 'anonpost';
$modversion['config'][4]['title'] = '_MI_ALT_ANONPOST';
...
$modversion['config'][5]['title'] = '_MI_ALT_AUTOAPPROVE';
$modversion['config'][5]['description'] = '_MI_ALT_AUTOAPPROVEDSC';
...
$modversion['notification']['category'][1]['title'] = _MI_ALT_NEWS_GLOBAL_NOTIFY;
$modversion['notification']['category'][1]['description'] = _MI_ALT_NEWS_GLOBAL_NOTIFYDSC;
$modversion['notification']['category'][1]['subscribe_from'] = ['index.php', 'article.php'];

$modversion['notification']['category'][2]['name'] = 'story';
$modversion['notification']['category'][2]['title'] = _MI_ALT_NEWS_STORY_NOTIFY;
$modversion['notification']['category'][2]['description'] = _MI_ALT_NEWS_STORY_NOTIFYDSC;
...
$modversion['notification']['event'][1]['title'] = _MI_ALT_NEWS_GLOBAL_NEWCATEGORY_NOTIFY;
$modversion['notification']['event'][1]['caption'] = _MI_ALT_NEWS_GLOBAL_NEWCATEGORY_NOTIFYCAP;
$modversion['notification']['event'][1]['description'] = _MI_ALT_NEWS_GLOBAL_NEWCATEGORY_NOTIFYDSC;
$modversion['notification']['event'][1]['mail_template'] = 'global_newcategory_notify';
$modversion['notification']['event'][1]['mail_subject'] = _MI_ALT_NEWS_GLOBAL_NEWCATEGORY_NOTIFYSBJ;

$modversion['notification']['event'][2]['name'] = 'story_submit';
$modversion['notification']['event'][2]['category'] = 'global';
$modversion['notification']['event'][2]['admin_only'] = 1;
$modversion['notification']['event'][2]['title'] = _MI_ALT_NEWS_GLOBAL_STORYSUBMIT_NOTIFY;
$modversion['notification']['event'][2]['caption'] = _MI_ALT_NEWS_GLOBAL_STORYSUBMIT_NOTIFYCAP;
$modversion['notification']['event'][2]['description'] = _MI_ALT_NEWS_GLOBAL_STORYSUBMIT_NOTIFYDSC;
$modversion['notification']['event'][2]['mail_template'] = 'global_storysubmit_notify';
$modversion['notification']['event'][2]['mail_subject'] = _MI_ALT_NEWS_GLOBAL_STORYSUBMIT_NOTIFYSBJ;

$modversion['notification']['event'][3]['name'] = 'new_story';
$modversion['notification']['event'][3]['category'] = 'global';
$modversion['notification']['event'][3]['title'] = _MI_ALT_NEWS_GLOBAL_NEWSTORY_NOTIFY;
$modversion['notification']['event'][3]['caption'] = _MI_ALT_NEWS_GLOBAL_NEWSTORY_NOTIFYCAP;
$modversion['notification']['event'][3]['description'] = _MI_ALT_NEWS_GLOBAL_NEWSTORY_NOTIFYDSC;
$modversion['notification']['event'][3]['mail_template'] = 'global_newstory_notify';
$modversion['notification']['event'][3]['mail_subject'] = _MI_ALT_NEWS_GLOBAL_NEWSTORY_NOTIFYSBJ;
...
$modversion['notification']['event'][4]['title'] = _MI_ALT_NEWS_STORY_APPROVE_NOTIFY;
$modversion['notification']['event'][4]['caption'] = _MI_ALT_NEWS_STORY_APPROVE_NOTIFYCAP;
$modversion['notification']['event'][4]['description'] = _MI_ALT_NEWS_STORY_APPROVE_NOTIFYDSC;
$modversion['notification']['event'][4]['mail_template'] = 'story_approve_notify';
$modversion['notification']['event'][4]['mail_subject'] = _MI_ALT_NEWS_STORY_APPROVE_NOTIFYSBJ;
